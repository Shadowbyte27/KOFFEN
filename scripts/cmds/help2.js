...
const doNotDelete = "[ ROMEO ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += ``;
      msg += `\n╭─────❃\n│ 💠 | [🎧𝙶𝙾𝙰𝚃𝙱𝙾𝚃🪶💙│𝙾𝚆𝙽𝙴𝚁 𝙵𝙱 𝙸𝙳:https://www.facebook.com/romeo.shadowbyte\n╰────────────✦`;            
        await message.reply({
        body: msg,
      });
    } else {
      ...
      if (!command) {
        ...
        const author = configCommand.author || "ROMEO SHADOWBYTE ";
 ...
 │ ${usage}
 ├──💙𝐍𝐨𝐭𝐞𝐬🪶💙
 │ 💙⚡𝚃𝚑𝚎 𝚌𝚘𝚗𝚝𝚎𝚗𝚝 inside <এꔰꜛ.`ROMEO`.ꜛꗄꔰ> 𝚌𝚊𝚗 𝚋𝚎 𝚌𝚑𝚊𝚗𝚐𝚎𝚍
